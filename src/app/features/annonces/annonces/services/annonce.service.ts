...
export class AnnonceService {
    ...
    // Get photos for an announcement (public)
    getAnnoncePhotos(annonceId: string): Observable<any[]> {
        return this.http.get<any[]>(`${environment.apiUrl}/photos/public/annonce/${annonceId}`);
    }
}
